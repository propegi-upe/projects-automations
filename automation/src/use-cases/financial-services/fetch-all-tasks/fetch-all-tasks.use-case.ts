...
const schema: FieldSchema = {
  ...
  Recurso: { fieldName: "Categoria do recurso", type: "singleSelect" },
  "SEI mãe": { fieldName: "SEI mãe", type: "text" },
  SEI: { fieldName: "SEI", type: "text" },
  "Data limite para empenho": { fieldName: "Data limite para empenho", type: "date" },
  "Data limite para liquidação": { fieldName: "Data limite para liquidação", type: "date" },
